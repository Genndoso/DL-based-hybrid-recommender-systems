...
def preproc_deep_fm(iteraction_df, item_df, user_df):
    """ combine interaction, items and users for deep fm trainning"""
    row_array = []
    ...
    res = pd.DataFrame(row_array)
    res.to_csv('./dataset/data.csv')
